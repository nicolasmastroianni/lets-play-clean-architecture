...
@Injectable()
export class DigimonKafkaProducerAdapter implements OnModuleInit, OnApplicationShutdown, EventRepository{
    ...
    async create(object: Digimon){
        ...
        await this.producer.send({ topic: 'digimon', messages: [{ value: JSON.stringify(digimon)}] })
    }
